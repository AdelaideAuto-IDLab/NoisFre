...
#define CHAR_UUID_CMD 0x0000 // command characteristic 
#define CHAR_UUID_STA 0x0001 // status characteristic
#define CHAR_UUID_CHA 0x0002 // challenge characteristic
#define CHAR_UUID_ADD 0x0003 // starting address characteristic
#define CHAR_UUID_LEN 0x0004 // memory length characteristic
#define CHAR_UUID_REP 0x0010 // response characteristic
...
typedef struct
{
    ...
    // OUR_JOB: Step 2.D, Add handles for the characteristic attributes to our struct
		ble_gatts_char_handles_t    CMD_handles;
		ble_gatts_char_handles_t    SAT_handles;
		ble_gatts_char_handles_t    CHA_handles;
		ble_gatts_char_handles_t    ADD_handles;
		ble_gatts_char_handles_t    LEN_handles;
		ble_gatts_char_handles_t    REP_handles;
}ble_os_t;
